...
rawData1 = pd.read_csv('/home/db/Documents/dipl/export_dataframe12.csv', nrows=3)
cols = rawData1.columns
rawData2 = pd.read_csv('/home/db/Documents/dipl/export_dataframe12.csv', skiprows=40254)
rawData2.columns = cols
rawData = pd.concat([rawData1, rawData2], ignore_index=True)
data = rawData.drop(['FLAG', 'CONS_NO'], axis=1).fillna(0)
...
data.loc[1].plot(ax=axs[1], color='firebrick', grid=True)
